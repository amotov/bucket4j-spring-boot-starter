...
import com.giffing.bucket4j.spring.boot.starter.filter.reactive.webflux.impl.DefaultWebfluxRateLimiterFilter;
...
class WebfluxRateLimitFilterTest {
	...
	private DefaultWebfluxRateLimiterFilter filter;
	...
	public void setup() throws URISyntaxException {
		...
		filter = new DefaultWebfluxRateLimiterFilter(configuration);
	}
